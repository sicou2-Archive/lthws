...
class Room_Alter(Room):
    ...
    def enter(self):
        ...
        if Engine.character.cast['orc'][3] == 1 and Engine.character.cast[
        'lockout']['bugbear'] == 1:
        ...
        if Engine.character.cast['orc'][3] == 1:
            # CHECK TO SEE IF ORC IS ALIVE WHEN COMING FROM ANOTHER ROOM
        ...
        while True:
            ...
            if action == '1':
                if Engine.character.cast['lockout']['alter'] == 0:
                ...
                while True:
                    ...
                    if choice == '1':
                        ...
                        if event == 1:
                            ...
                            Engine.character.cast['hero'][5] += 5
                                #maxhp +5
                            print(Engine.character.cast['hero'])
                            Engine.character.cast[
                            'hero'][0] = Engine.character.cast['hero'][5]
                                #HEALTH TO MAX
                            Engine.character.cast['hero'][6] = 1
                            print(Engine.character.cast['hero'])
                            Engine.character.cast['lockout']['alter'] = 0
                            break
                    elif choice == '2':
                ...
                if (Engine.character.cast['lockout']['chest_room'] == 0 and
                    Engine.character.cast['lockout']['slime_room'] == 0):
        ...
        if Engine.character.cast['bugbear'][3] == 1:
            ...
            while True:
                ...
                if action == '1':
                            ...
                            while True:
                                if choice == '1':
                                    ...
                                    if sneak_roll == 1:
                                        ...
                                        Engine.rest(Engine.character.cast[
                                        'hero'])
                                        return 'hallway'
                                elif i == 3:
                                    Engine.fprint(Text.hallway[
                    ...
                    return 'end_game'
        elif Engine.character.cast['bugbear'][3] == 0:
            Engine.fprint(Text.hallway['victory'])
            return 'crypt'
        else:
...
class Room_Crypt(Room):
    ...
    def enter(self):
        # try:
            # Engine.character.cast['skeleton']
        # except KeyError:
        ...
        while True:
            ...
            try:
                Engine.character.cast['gem']
            except KeyError:
                gem = 0
                Engine.character.cast['gem'] = gem
...
class Room_Outside(Room):
    ...
    def enter(self):
        ...
        if Engine.character.cast['gem'] == 1:
...
class Actions(object):
    ...
    def sneak(odds, caught_text, sneak_text):
        """This is a place holder for creating a sneak function here."""
        # sneak_roll = randint(1, odds)
...
# # THERE ARE A LOT OF ARGUMENTS HERE
    ...
    def rest(hero):
        ...
        to the set max_hp.
        """
        if Engine.character.cast['hero'][6] == 1:
            ...
            Engine.character.cast['hero'][0] = hero[5]
